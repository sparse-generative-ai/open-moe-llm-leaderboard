...
if __name__ == "__main__":
    ...
    with open(f"/home/jysc/open-moe-llm-leaderboard/profiling/decoding_trace_qwen_bs16_layer23_tot55287.pkl", "rb") as f:
    ...
    del record
    gc.collect()
    with open(f"num_activated_experts_{model_name}_tot{batch_size}.pkl", "wb") as f:
