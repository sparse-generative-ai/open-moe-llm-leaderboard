...
# python $converter --workers 4 --tp_size 4 --model_dir $checkpoint --output_dir $model_name-ckpt-bfloat16 --dtype $dtype
# python $converter --tp_size 4 --model_dir $checkpoint --output_dir $model_name-ckpt-int8 --dtype $dtype --use_weight_only --weight_only_precision int8
